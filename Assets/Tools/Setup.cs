...
namespace MyTools
{
    public static class Setup
    {
        ...
        {
            Folders.CreateDefault("_Script", "Animation", "Art", "Prefabs", "Scripts/ScriptableObjects", "Scripts/UI");
            Refresh();
        }
        ...
        static class Assets
        {
            public static void ImportAsset(string asset, string subfolder,
                string rootFolder = "C:/Users/ADMIN/AppData/Roaming/Unity/Asset Store-5.x")
            {
